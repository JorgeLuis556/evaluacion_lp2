...
-- CREAR BD Y TABLAS (ya está en el script original)

-- Datos de prueba para clientes
INSERT INTO clientes(nombre,email) VALUES
  ('Ana Pérez','ana.perez@correo.com'),
  ('Luis Gómez','luis.gomez@correo.com'),
  ('María Ruiz','maria.ruiz@correo.com');

-- Datos de prueba para películas
INSERT INTO peliculas(titulo,genero,stock) VALUES
  ('El Padrino','Drama',5),
  ('Jurassic Park','Aventura',3),
  ('Matrix','Ciencia ficción',4);
